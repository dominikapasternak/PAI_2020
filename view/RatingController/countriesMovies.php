...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="public/countriesmovies.css">
...
<div class="page-wraper-container">
    <div class="flex site-bar">
        <!-- TUTAJ ODCZYTUJE TA ZMIENNA movie Z RATINGCONTROLLER -->
<?php if(isset($movie)): ?>
    <div class="name">
        <ol class="surnames">
            <?php foreach($movie as $p): ?>
            <li class="s"><a href="http://localhost/filmwar?page=ratingMovies&id_movie=<?= $p['id_movie'];?>"><?= $p['name'];?></a></li>
            <?php endforeach; ?>
        </ol>
    </div>
<?php endif; ?>
